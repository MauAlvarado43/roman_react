...
docker-compose -f bin/docker/docker-compose-dev.yml exec roman_reactjs /bin/sh -c "cp bin/docker/deploy-dev.sh bin/docker/win-deploy-dev.sh"
docker-compose -f bin/docker/docker-compose-dev.yml exec roman_reactjs /bin/sh -c "sed -i 's/\r$//g' bin/docker/win-deploy-dev.sh"
docker-compose -f bin/docker/docker-compose-dev.yml exec roman_reactjs /bin/sh -c "bin/docker/win-deploy-dev.sh %KEY% %HOST% %GIT_URL% %GIT_BRANCH%"
docker-compose -f bin/docker/docker-compose-dev.yml exec roman_reactjs /bin/sh -c "rm bin/docker/win-deploy-dev.sh"