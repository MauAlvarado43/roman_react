...
sudo docker-compose -f bin/docker/docker-compose-dev.yml run roman_reactjs /bin/sh -c "chmod +x bin/*.sh;chmod +x bin/docker/*.sh"

echo "== Starting services"
sudo docker-compose -f bin/docker/docker-compose-dev.yml up -d

echo "== Generating docs"
sudo docker-compose -f bin/docker/docker-compose-dev.yml exec roman_reactjs /bin/sh -c "jsdoc ./src -c ./bin/config/docs/config.json --readme README.md -t /node_modules/docdash"
