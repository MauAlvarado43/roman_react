...
const ProcessDetails = ({ process, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${process.id}/edit`} class="btn btn-secondary mr-2">Edit process</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete process</button>
      </div>
    </div>
  </div>;
